...
func TestParseShares(t *testing.T) {
	...
	tests := []testCase{
		...
		},
		{
			...
			[][]byte{txShareStart},
			[]ShareSequence{{Namespace: appconsts.TxNamespaceID, Shares: []Share{txShareStart}}},
			false,
		},
		{
			"two transaction shares",
			[][]byte{txShareStart, txShareContinuation},
			[]ShareSequence{{Namespace: appconsts.TxNamespaceID, Shares: []Share{txShareStart, txShareContinuation}}},
			false,
		},
		{
			"one blob share",
			[][]byte{blobOneStart},
			[]ShareSequence{{Namespace: blobOneNamespace, Shares: []Share{blobOneStart}}},
			false,
		},
		{
			"two blob shares",
			[][]byte{blobOneStart, blobOneContinuation},
			[]ShareSequence{{Namespace: blobOneNamespace, Shares: []Share{blobOneStart, blobOneContinuation}}},
			false,
		},
		{
			...
			[]ShareSequence{
				{Namespace: blobOneNamespace, Shares: []Share{blobOneStart, blobOneContinuation}},
				{Namespace: blobTwoNamespace, Shares: []Share{blobTwoStart, blobTwoContinuation}},
			},
			false,
		},
		{
			...
			[]ShareSequence{
				{Namespace: appconsts.TxNamespaceID, Shares: []Share{txShareStart}},
				{Namespace: blobOneNamespace, Shares: []Share{blobOneStart}},
			},
			false,
		},
		{
			...
			[]ShareSequence{
				{Namespace: appconsts.TxNamespaceID, Shares: []Share{txShareStart}},
				{Namespace: blobOneNamespace, Shares: []Share{blobOneStart}},
				{Namespace: blobTwoNamespace, Shares: []Share{blobTwoStart}},
			},
			false,
		},
		{
