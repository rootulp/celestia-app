...
func (app *App) Info(req *abci.RequestInfo) (*abci.ResponseInfo, error) {
	fmt.Fprintf(os.Stderr, "v5.x app/app.go Info invoked\n")
	...
	fmt.Fprintf(os.Stderr, "v5.x app/app.go Info result: %v\n", res)
...
func (app *App) TimeoutCommit() time.Duration {
	fmt.Fprintf(os.Stderr, "v5.x app/app.go TimeoutCommit invoked\n")
	if app.timeoutCommit != 0 {
		fmt.Fprintf(os.Stderr, "v5.x app/app.go TimeoutCommit returning user specified value: %v\n", app.timeoutCommit)
		return app.timeoutCommit
	}
	fmt.Fprintf(os.Stderr, "v5.x app/app.go TimeoutCommit returning default value: %v\n", appconsts.TimeoutCommit)
...
func (app *App) TimeoutPropose() time.Duration {
	fmt.Fprintf(os.Stderr, "v5.x app/app.go TimeoutPropose returning default value: %v\n", appconsts.TimeoutPropose)
