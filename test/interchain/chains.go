...
// getChains returns two chains for testing: Celestia and Cosmos Hub.
func getChains(t *testing.T) (celestia *cosmos.CosmosChain, stride *cosmos.CosmosChain) {
	factory := interchaintest.NewBuiltinChainFactory(zaptest.NewLogger(t), []*interchaintest.ChainSpec{chainspec.Celestia, chainspec.Cosmos})
